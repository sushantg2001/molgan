...
class Solver(object):
    ...
    def __init__(self, config):
        ...
        print("b_dim ",self.b_dim," m_dim ",self.m_dim)
        ...
        self.metric = 'validity,unique,novelty'
        ...
        self.m1_result_dir = config.result_dir
    ...
    def train(self):
        ...
        for i in range(start_iters, self.num_iters):
            ...
            if (i+1) % self.log_step == 0:
                ...
                m0.update(m1)
                f = open(f'{self.metric_scores}/{datetime.datetime.now()}.txt','w+')
    ...
    def check_m1(self, name):
        ...
        dir_path = f'm1'
        os.system(f"python m1/transformer-cnn.py '{input_path}' '{result_path}' '{dir_path}'")
    ...
    def test(self):
        ...
        name = self.generate_smiles(mols)
        self.check_m1(name)
