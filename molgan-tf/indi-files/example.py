...
import sparse_molecular
from molecular_metrices import MolecularMetrics
from utils import *
from gan_optimiser import GraphGANOptimizer
from models_gan import GraphGANModel
...
dropout = 0
n_critic = 5
metric = 'odor,validity,unique,novelty'
n_samples = 5000
z_dim = 8
epochs = 10
save_every = 1  # May lead to errors if left as None

data = sparse_molecular.SparseMolecularDataset()
